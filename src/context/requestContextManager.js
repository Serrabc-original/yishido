...
export function buildRequestContext(input) {
  ...
  const context = redactForLog({
    ...
    longTermMemory: compactObject(clean.longTermMemory || null, 1200),
    memoryPolicy: compactObject(clean.memoryPolicy || null, 900),
    memoryReadModel: compactObject(clean.memoryReadModel || null, 1800),
...
export function buildSupervisorInput(input) {
  ...
  return {
    ...
    longTermMemory: requestContext.longTermMemory || null,
    memoryPolicy: requestContext.memoryPolicy || null,
    memoryReadModel: requestContext.memoryReadModel || null,
